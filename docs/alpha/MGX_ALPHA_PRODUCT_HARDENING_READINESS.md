...
| mobile playable | PASS in emulation for Core 5 / physical QA pending | Core 5 UI audit now passes D01/D02/S01/S02 and Badugi on cash portrait, cash landscape, tournament portrait, tournament landscape, interaction, and desktop; Badugi remains preview-only for physical mobile QA |
