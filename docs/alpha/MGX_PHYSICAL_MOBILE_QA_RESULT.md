...
If either issue reproduces, export the freeze report JSON and save a screenshot. Friend alpha remains HOLD until the real-device recheck passes and remote sync is resolved.
