...
| `BG-005` | Mobile manual QA | Chrome/Playwright mobile emulation passes for alpha variant gate and dashboard preview; physical device QA and Badugi mobile full-hand gameplay remain incomplete. | P1 | `docs/alpha/MGX_ALPHA_MOBILE_MANUAL_QA.md` | Run real Android/iOS QA before exposing Badugi or expanding alpha scope. |
