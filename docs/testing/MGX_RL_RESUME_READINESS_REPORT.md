...
| REWARD-GATE | PARTIAL | No | Numeric reward is enforced. Semantic EV/reward sign audit remains a future hand-history benchmark task. |
...
|---|---|---|---|---|---|---|
| D03 Badugi | PASS | PASS | PASS | PASS numeric | PASS | SAFE FOR CLEAN-DATA TRAINING |
| D01 2-7 Triple Draw | PASS | PASS | PASS | PASS numeric | PASS | SAFE FOR CLEAN-DATA TRAINING |
| D02 A-5 Triple Draw | PASS | PASS | PASS | PASS numeric | PASS | SAFE FOR CLEAN-DATA TRAINING |
| S01 2-7 Single Draw | PASS | PASS | PASS | PASS numeric | PASS | SAFE FOR CLEAN-DATA TRAINING |
| S02 A-5 Single Draw | PASS | PASS | PASS | PASS numeric | PASS | SAFE FOR CLEAN-DATA TRAINING |
...
|---|---|---|
| Reward semantic consistency is numeric-only in this gate | MEDIUM | Add hand-history EV/winner reward sign benchmark before Pro/WorldMaster promotions. |
