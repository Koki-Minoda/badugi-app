...
| Bug-02 | Bet round never ends with multiple all-ins | REGRESSION | Folded SB + all-in mix still stalls BET in some scenarios (needs rework) |
...
| Bug-09 | All-in players skip DRAW | REGRESSION | Some all-in seats still get removed from DRAW / cannot act in later rounds |
